...
public class ModRecipeProvider extends RecipeProvider implements IConditionBuilder {
    ...
    protected void buildRecipes(Consumer<FinishedRecipe> consumer) {
      //  oreSmelting(consumer, List.of(HalfLifeItems.RAW_BLACK_OPAL.get()), RecipeCategory.MISC,
     ...
     //           ModBlocks.BLACK_OPAL_BLOCK.get());
        ...
        //         .save(consumer);
         ...
         ShapedRecipeBuilder.shaped(RecipeCategory.MISC, HalfLifeItems.DISPLACER_END.get())
                 .define('B', Items.ENDER_EYE.asItem())
                 .define('S', Items.SHULKER_SHELL.asItem())
                 .define('D', HalfLifeItems.DISPLACER.get())
                 .pattern("BSB")
                .pattern("SDS")
                .pattern("BSB")
                 .unlockedBy(getHasName(HalfLifeItems.DISPLACER.get()), has(HalfLifeItems.DISPLACER.get()))
                .save(consumer);


        ShapedRecipeBuilder.shaped(RecipeCategory.MISC, HalfLifeItems.DISPLACER_NETHER.get())
                .define('O', Items.OBSIDIAN.asItem())
                .define('S', Items.NETHER_STAR.asItem())
                .define('B', Items.BLAZE_POWDER.asItem())
                .define('D', HalfLifeItems.DISPLACER.get())
                .pattern("OSO")
                .pattern("ODO")
                .pattern("BOB")
    ...
    protected static void oreCooking(Consumer<FinishedRecipe> p_250791_, RecipeSerializer<? extends AbstractCookingRecipe> p_251817_, List<ItemLike> p_249619_, RecipeCategory p_251154_, ItemLike p_250066_, float p_251871_, int p_251316_, String p_251450_, String p_249236_) {
        for(ItemLike itemlike : p_249619_) {
            SimpleCookingRecipeBuilder.generic(Ingredient.of(itemlike), p_251154_, p_250066_, p_251871_, p_251316_, p_251817_).group(p_251450_)
                    .unlockedBy(getHasName(itemlike), has(itemlike)).save(p_250791_, new ResourceLocation(HalfLifeMod.MOD_ID, getItemName(p_250066_)) + p_249236_ + "_" + getItemName(itemlike));
        }
    }
    ...
    protected static void nineBlockStorageRecipes(Consumer<FinishedRecipe> p_250423_, RecipeCategory p_250083_, ItemLike p_250042_,
        ...
        ShapelessRecipeBuilder.shapeless(p_250083_, p_250042_, 9).requires(p_251911_).group(p_250414_).unlockedBy(getHasName(p_251911_), has(p_251911_))
                .save(p_250423_, new ResourceLocation(HalfLifeMod.MOD_ID, p_252237_));
        ShapedRecipeBuilder.shaped(p_248977_, p_251911_).define('#', p_250042_).pattern("###").pattern("###").pattern("###").group(p_248641_)
                .unlockedBy(getHasName(p_250042_), has(p_250042_)).save(p_250423_, new ResourceLocation(HalfLifeMod.MOD_ID, p_250475_));
    }
