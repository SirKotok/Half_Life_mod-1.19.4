...
public class VortLightningParticle extends Particle {
    ...
    public VortLightningParticle(ClientLevel world, double x, double y, double z, double xd, double yd, double zd) {
        super(world, x, y, z);
        ...
        LightningBoltData.BoltRenderInfo boltData = new LightningBoltData.BoltRenderInfo(0.0F, 0.15F, 0.1F, 0.02F, new Vector4f(0.1F , 0.8F, 0.1F, 0.3F), 0.5F);
