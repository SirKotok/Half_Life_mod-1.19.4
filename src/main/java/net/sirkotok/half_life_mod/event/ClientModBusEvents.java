...
public class ClientModBusEvents {
    ...
    public static void onClientSetup(FMLClientSetupEvent event)
    {
        ...
        EntityRenderers.register(ModEntities.CONTROLLER.get(), ControllerRenderer::new);
        ...
        EntityRenderers.register(ModEntities.HUNTER.get(), Hunter_renderer::new);
        ...
        EntityRenderers.register(ModEntities.FLECHETTE.get(), Flechette_renderer::new);
