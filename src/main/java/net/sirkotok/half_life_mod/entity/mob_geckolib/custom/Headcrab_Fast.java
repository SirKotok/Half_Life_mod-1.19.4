...
public class Headcrab_Fast extends HalfLifeMonster implements GeoEntity, SmartBrainOwner<Headcrab_Fast> {
    ...
    public static final EntityDataAccessor<Boolean> NO_DROP = SynchedEntityData.defineId(Headcrab_Fast.class, EntityDataSerializers.BOOLEAN);
    ...
    public void tick() {
         ...
         if (!this.level.isClientSide && this.isPassenger()) {
             ...
             if (target instanceof LivingEntity){
                 ...
                 if (target instanceof HL2Zombie_fast) {
    ...
    private <T extends GeoAnimatable> PlayState predicate(AnimationState<T> tAnimationState) {
        ...
        if (this.isPassenger() && this.getVehicle() instanceof HL2Zombie_fast) {
