...
public class SharkPart extends net.minecraftforge.entity.PartEntity<Shark> {

    public final Shark parentMob;
    public final String name;
    private final EntityDimensions size;


    public SharkPart(Shark pParentMob, String pName, float pWidth, float pHeight) {
        super(pParentMob);
