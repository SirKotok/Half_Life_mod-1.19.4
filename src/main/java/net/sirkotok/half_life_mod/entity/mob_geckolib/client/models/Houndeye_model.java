    ...
    public ResourceLocation getTextureResource(Houndeye dog) {
        ...
        if (dog.islight()) {
            ...
            switch(dog.getsquaidsize()) {
                case 0: return new ResourceLocation(HalfLifeMod.MOD_ID, "textures/entity/houndeye_g_light_blue.png");
                case 1: return new ResourceLocation(HalfLifeMod.MOD_ID, "textures/entity/houndeye_g_blue.png");
                case 2: return new ResourceLocation(HalfLifeMod.MOD_ID, "textures/entity/houndeye_g_deep_blue.png");
            }
        }
         if (dog.getsquaidsize()>3) return new ResourceLocation(HalfLifeMod.MOD_ID, "textures/entity/houndeye_purple.png");
        switch(dog.getsquaidsize()) {
            case 0: return new ResourceLocation(HalfLifeMod.MOD_ID, "textures/entity/houndeye_light_blue.png");
            case 1: return new ResourceLocation(HalfLifeMod.MOD_ID, "textures/entity/houndeye_blue.png");
            case 2: return new ResourceLocation(HalfLifeMod.MOD_ID, "textures/entity/houndeye_deep_blue.png");
        }
