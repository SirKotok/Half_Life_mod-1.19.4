...
public class ZombieScientistRenderCoatLayer extends GeoRenderLayer<ZombieHl1> {

    public ZombieScientistRenderCoatLayer(GeoRenderer<ZombieHl1> entityRenderer) {
