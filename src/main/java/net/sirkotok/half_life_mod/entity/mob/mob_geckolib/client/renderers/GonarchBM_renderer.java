...
import net.sirkotok.half_life_mod.entity.mob.mob_geckolib.client.models.GonarchBM_model;
import software.bernie.geckolib.renderer.GeoEntityRenderer;
import software.bernie.geckolib.util.RenderUtils;


public class GonarchBM_renderer extends GeoEntityRenderer<GonarchBM> {
    public GonarchBM_renderer(EntityRendererProvider.Context renderManager) {
        super(renderManager, new GonarchBM_model());
    }



    @Override
    public void render(GonarchBM entity, float entityYaw,
    ...
    @Override
    protected void applyRotations(GonarchBM animatable, PoseStack poseStack, float ageInTicks, float rotationYaw, float partialTick) {
        Pose pose = animatable.getPose();
        GonarchBM livingEntity = animatable;
