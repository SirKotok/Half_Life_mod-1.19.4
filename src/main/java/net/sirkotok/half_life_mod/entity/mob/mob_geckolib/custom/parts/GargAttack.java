...
public class GargAttack extends net.minecraftforge.entity.PartEntity<Gargantua> {

    public final Gargantua parentMob;
    public final String name;
    private final EntityDimensions size;


    public GargAttack(Gargantua pParentMob, String pName, float pWidth, float pHeight) {
        super(pParentMob);
