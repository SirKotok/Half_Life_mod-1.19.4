...
import net.sirkotok.half_life_mod.entity.mob.mob_geckolib.client.models.Zombiehl2_model;
...
public class Zombiehl2_renderer extends DynamicGeoEntityRenderer<HL2Zombie> {
    ...
    @Override
    public void render(HL2Zombie entity, float entityYaw,
    ...
    @Nullable
       @Override
     protected ResourceLocation getTextureOverrideForBone(GeoBone bone, HL2Zombie animatable, float partialTick) {
