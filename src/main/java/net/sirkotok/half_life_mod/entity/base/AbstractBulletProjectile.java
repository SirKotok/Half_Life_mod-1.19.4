...
public abstract class AbstractBulletProjectile extends Projectile {
    ...
    protected AbstractBulletProjectile(EntityType<? extends AbstractBulletProjectile> pEntityType, Level pLevel) {
        super(pEntityType, pLevel);
    }

    public AbstractBulletProjectile(EntityType<? extends AbstractBulletProjectile> pEntityType, double pX, double pY, double pZ, double pOffsetX, double pOffsetY, double pOffsetZ, Level pLevel) {
    ...
    protected AbstractBulletProjectile(EntityType<? extends AbstractBulletProjectile> pEntityType, double pX, double pY, double pZ, Level pLevel) {
        this(pEntityType, pLevel);
        this.setPos(pX, pY, pZ);
    }

    protected AbstractBulletProjectile(EntityType<? extends AbstractBulletProjectile> pEntityType, LivingEntity pShooter, Level pLevel) {
    ...
    public AbstractBulletProjectile(EntityType<? extends AbstractBulletProjectile> pEntityType, LivingEntity pShooter, double pOffsetX, double pOffsetY, double pOffsetZ, Level pLevel) {
