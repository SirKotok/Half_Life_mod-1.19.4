...
public class HalfLifeEntity<T extends HalfLifeEntity<T>> extends Monster {

    public static final EntityDataAccessor<Integer> ENTITY_MODEL = SynchedEntityData.defineId(HalfLifeEntity.class, EntityDataSerializers.INT);




    protected HalfLifeEntity(EntityType<? extends Monster> type, Level level) {
        super(type, level);
        this.xpReward = 5;
