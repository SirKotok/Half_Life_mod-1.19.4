...
@OnlyIn(Dist.CLIENT)
public class GravityGunBlockRenderer extends EntityRenderer<GravityGunFallingBlockEntity> {
    private final BlockRenderDispatcher dispatcher;

    public GravityGunBlockRenderer(EntityRendererProvider.Context pContext) {
        super(pContext);
        this.shadowRadius = 0.5F;
        this.dispatcher = pContext.getBlockRenderDispatcher();
    }

    public void render(GravityGunFallingBlockEntity pEntity, float pEntityYaw, float pPartialTicks, PoseStack pMatrixStack, MultiBufferSource pBuffer, int pPackedLight) {
     ...
     */
    public ResourceLocation getTextureLocation(GravityGunFallingBlockEntity pEntity) {
