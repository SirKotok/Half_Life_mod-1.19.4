...
public class SporeShotBroken extends ThrowableProjectile implements GeoEntity {
    ...
    public SporeShotBroken(EntityType<? extends ThrowableProjectile> pEntityType, Level pLevel) {
        super(pEntityType, pLevel);
    }

    public SporeShotBroken(Level pLevel, LivingEntity pShooter) {
        super(HalfLifeEntities.SPORESHOT.get(), pShooter, pLevel);
    }



    public static final EntityDataAccessor<Float> JUMP = SynchedEntityData.defineId(SporeShotBroken.class, EntityDataSerializers.FLOAT);
    public static final EntityDataAccessor<Integer> BOUNCE_ID = SynchedEntityData.defineId(SporeShotBroken.class, EntityDataSerializers.INT);
    public static final EntityDataAccessor<Integer> TICkS_REMAINING =  SynchedEntityData.defineId(SporeShotBroken.class, EntityDataSerializers.INT);
    public static final EntityDataAccessor<Integer> JUMP_TIMESTAMP =  SynchedEntityData.defineId(SporeShotBroken.class, EntityDataSerializers.INT);
