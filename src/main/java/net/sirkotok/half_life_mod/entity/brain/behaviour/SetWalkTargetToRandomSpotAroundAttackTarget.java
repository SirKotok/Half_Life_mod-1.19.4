...
public class SetWalkTargetToRandomSpotAroundAttackTarget<E extends PathfinderMob> extends ExtendedBehaviour<E> {
    ...
    public SetWalkTargetToRandomSpotAroundAttackTarget<E> speedMod(float speedModifier) {
    ...
    protected Vec3 getTargetPos(E entity) {
            ...
            return DefaultRandomPos.getPosTowards(entity, (int)this.radius.xzRadius(), (int)this.radius.yRadius(), target, 1);
    }
}
