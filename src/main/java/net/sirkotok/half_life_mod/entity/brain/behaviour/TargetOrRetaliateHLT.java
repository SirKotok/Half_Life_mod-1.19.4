 ...
 * @param <E> The entity
 */
public class TargetOrRetaliateHLT<E extends Mob> extends ExtendedBehaviour<E> {
     ...
     * @return this
     */
    public TargetOrRetaliateHLT<E> attackablePredicate(Predicate<LivingEntity> predicate) {
     ...
     * @return this
     */
    public TargetOrRetaliateHLT<E> useMemory(MemoryModuleType<? extends LivingEntity> memory) {
     ...
     * @return this
     */
    public TargetOrRetaliateHLT<E> alertAlliesWhen(BiPredicate<E, Entity> predicate) {
     ...
     * @return this
     */
    public TargetOrRetaliateHLT<E> isAllyIf(BiPredicate<E, LivingEntity> predicate) {
