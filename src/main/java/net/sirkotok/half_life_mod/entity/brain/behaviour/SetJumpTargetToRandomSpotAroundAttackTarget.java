...
public class SetJumpTargetToRandomSpotAroundAttackTarget<E extends PathfinderMob> extends ExtendedBehaviour<E> {
    ...
    public SetJumpTargetToRandomSpotAroundAttackTarget(int self012) {
        this.self012 = self012;
    }


    public SetJumpTargetToRandomSpotAroundAttackTarget<E> speedMod(float speedModifier) {
    ...
    public SetJumpTargetToRandomSpotAroundAttackTarget<E> radius(int xz, int y) {
    ...
    public BlockPos movePosUpOutOfSolid(LivingEntity pMob, BlockPos pPos) {
        ...
        return !pMob.level.getFluidState(pPos).is(FluidTags.WATER) ? pPos : null;
    }
