...
public class SwitchTarget<E extends Mob> extends ExtendedBehaviour<E> {
    private static final List<Pair<MemoryModuleType<?>, MemoryStatus>> MEMORY_REQUIREMENTS = ObjectArrayList.of(Pair.of(MemoryModuleType.ATTACK_TARGET, MemoryStatus.REGISTERED), Pair.of(MemoryModuleType.HURT_BY, MemoryStatus.REGISTERED), Pair.of(MemoryModuleType.NEAREST_ATTACKABLE, MemoryStatus.REGISTERED), Pair.of(MemoryModuleType.NEAREST_VISIBLE_LIVING_ENTITIES, MemoryStatus.REGISTERED));
     ...
     * @return this
     */
    public SwitchTarget<E> attackablePredicate(Predicate<LivingEntity> predicate) {
     ...
     * @return this
     */
    public SwitchTarget<E> useMemory(MemoryModuleType<? extends LivingEntity> memory) {
     ...
     * @return this
     */
    public SwitchTarget<E> alertAlliesWhen(BiPredicate<E, Entity> predicate) {
     ...
     * @return this
     */
    public SwitchTarget<E> isAllyIf(BiPredicate<E, LivingEntity> predicate) {
    ...
    protected boolean checkExtraStartConditions(ServerLevel level, E owner) {
        ...
        return this.canAttackPredicate.test(this.toTarget) && !flag;
    }
