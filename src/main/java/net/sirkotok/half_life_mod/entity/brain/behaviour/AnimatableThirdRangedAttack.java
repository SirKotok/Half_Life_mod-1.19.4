...
public class AnimatableThirdRangedAttack<E extends LivingEntity & TripleRangedMob> extends DelayedBehaviour<E> {
    ...
    public AnimatableThirdRangedAttack(int delayTicks) {
        super(delayTicks);
     ...
     * @return this
     */
    public AnimatableThirdRangedAttack<E> attackInterval(Function<E, Integer> supplier) {
     ...
     * @return this
     */
    public AnimatableThirdRangedAttack<E> attackRadius(float radius) {
    ...
    protected void doDelayedAction(E entity) {
        ...
        entity.performThirdRangedAttack(this.target, 1);
