...
import net.sirkotok.half_life_mod.entity.particle.custom.projectile_impact.BigImpactParticle;
import net.sirkotok.half_life_mod.entity.particle.custom.projectile_impact.BulletHoleParticle;
import net.sirkotok.half_life_mod.misc.util.KeyBinding;
...
public class ClientModBusEvents {
    ...
    public static void registerParticleFactories(RegisterParticleProvidersEvent event){
        ...
        event.registerSpecial(HalfLifeParticles.GRAV_GUN_BLUE_LIGHTNING.get(), new GravGunParticleBlue.Factory());
    ...
    public static void onClientSetup(FMLClientSetupEvent event)
    {
        ...
        EntityRenderers.register(HalfLifeEntities.AQUATIC_BULLSQUID.get(), AquaticBullsquid_renderer::new);
        ...
        EntityRenderers.register(HalfLifeEntities.HECU_GRUNT.get(), HECU_Renderer::new);
        EntityRenderers.register(HalfLifeEntities.SCIENTIST.get(), Scientist_renderer2::new);
        EntityRenderers.register(HalfLifeEntities.GONOME.get(),Gonomerenderer::new);
